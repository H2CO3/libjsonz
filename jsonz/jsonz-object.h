...
void jsonz_object_string_set_str(jsonz_object_string_t *string, const char *str_new);
...
void *jsonz_object_object_get_element(jsonz_object_object_t *obj, const char *key);
void jsonz_object_object_set_element(jsonz_object_object_t *obj, const char *key, void *element);
void jsonz_object_object_delete_element(jsonz_object_object_t *obj, const char *key);
